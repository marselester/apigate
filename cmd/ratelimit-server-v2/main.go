// Program ratelimit-server-v2 is gRPC server that throttles all API requests.
// It's based on rls.proto copied from https://github.com/lyft/ratelimit.
package main
...
import (
	...
	pb "github.com/marselester/apigate/internal/envoy/service/ratelimit/v2"
)
